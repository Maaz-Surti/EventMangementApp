...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        var isLoggedIn = Foundation.UserDefaults.standard.bool(forKey: "LoggedIn")
        ...
        if isLoggedIn == true
        {
            let vc = storyboard?.instantiateViewController(identifier: "barvc") as! UITabBarController
